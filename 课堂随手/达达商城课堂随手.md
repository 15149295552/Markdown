...
1. settings.py中配置缓存配置项

   ```python
   CACHES = {
       "default": {"LOCATION": "xxx"}
   }
   ```
...
如果未安装，则安装django-redis组件

​     `pip3 install django-redis`

如果是4版本，则升级为5版本，升级命令如下：

​     `pip3 install django-redis --upgrade`



我：zhaoliying   拥有了自己的token

我发请求：http://127.0.0.1:8000/v1/users/dilireba/address
...
```python
# 新增|查询
http://127.0.0.1:8000/v1/users/dilireba/address
...
<font color=red>一个URL地址，四种动作！</font>
...
第一步：path("xxx/xxx", views.类名.as_view())
