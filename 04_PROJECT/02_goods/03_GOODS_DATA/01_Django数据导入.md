...
### 1.1 dumpdata 基本数据库的转存

​	<font color=blue>下面的命令将把整个数据转存到db.json文件中 </font>
...
<font color=blue>这个命令可以用来导入固定格式的数据(数据库 dumps)到数据库 </font>
