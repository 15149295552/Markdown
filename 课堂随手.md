...
2. [TOC]
   ...
   **<font color=red>在浏览器中，Cookie是服务器让浏览器帮忙存储和携带信息的手段，浏览器会存储它，并且在后续的HTTP请求中再次发送给服务器。</font>**
   ...
   ![](../../../typora/Typora/imgs/02_COOKIES_SESSION.png)
   ...
   2. 视图中保存session(django_session表)
      ...
      ![](../../../typora/Typora/imgs/05_django_session.png)
   ...
   3. 创建缓存表：`python3 manage.py createcachetable`
      ...
      ![](../../../typora/Typora/imgs/06_cache_table.png)
   ...
   ![](../../../typora/Typora/imgs/04_%E4%B8%AD%E9%97%B4%E4%BB%B6.png)
   ...
   4. 中间件官方原理图
      ...
      ![](../../../typora/Typora/imgs/07_middleware.jpeg)
